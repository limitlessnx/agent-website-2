    ...
    <main className={`quantix-home ${styles.home}`}>
      ...
      <section className="brand-section production-pricing-carousel" id="pricing">
        <div className="brand-shell">
          <div className="brand-heading"><span className="brand-eyebrow">Choose your automation level</span><h2>Plans built for different levels of automation.</h2><p>Start with the level that fits your operation today, then expand as your channels, workflows and customer volume grow.</p></div>
          <HomePricingOverview plans={pricingPlans} />
          <div className="hero-buttons production-pricing-route-link"><Link className="button-secondary" href="/pricing" data-cta="pricing-details">See full pricing details <ArrowRight size={16} /></Link></div>
