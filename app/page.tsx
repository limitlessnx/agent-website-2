...
const pricingPlans = [
  {
    ...
    description: "A focused AI front desk for instant response, qualification, customer capture and human handoff without automated follow-up.",
    features: [
      "2,500 monthly Flux Credits",
      "One primary customer route",
      "Website AI or WhatsApp AI support",
  ...
  },
  {
    ...
    description: "Everything in Basic, with automated follow-up and reminders on one selected customer route: WhatsApp AI or a Voice Call Agent.",
    features: [
  ...
  },
  {
    ...
    description: "Everything in Plus, with multiple AI agents and customer routes operating together, email automation, higher usage, admin controls and Leo Admin Assistance.",
    features: [
      ...
      "Leo Voice and Leo Admin Assistance",
      "Workflow visibility, reporting and escalation controls",
    ],
    cta: "View Business",
    featured: true,
  },
  {
    ...
    name: "Custom",
    ongoing: "",
    description: "A tailored Fluxknight deployment for organizations that need industry databases, deeper integrations, custom workflows, dashboards or operating systems built around how the business actually works.",
    features: [
      ...
      <section className="brand-section production-pricing-carousel" id="pricing">
        <div className="brand-shell">
          <div className="brand-heading">
            ...
            <p>Basic handles the core front desk. Plus adds follow-up and reminders on one selected customer route. Business brings multiple AI agents and routes together with email automation. Custom is tailored for deeper databases, integrations and operating workflows.</p>
          </div>
