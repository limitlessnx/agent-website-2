...
import { Activity, Bell, Bot, Building2, CheckCircle2, ChevronDown, CircleDashed, MessageSquare, Network, Search, Settings, ShieldCheck, Target, Users, Workflow, Zap } from "@/components/admin/ServerIcons";
  ...
  return (
    <main className={`${styles.page} admin-page`}>
      ...
      <section className={styles.maiaHero}>
        ...
        <div className={styles.maiaCopy}><div className={styles.eyebrow}>Limitless Realty · Maia <span className={styles.statusPill}><CircleDashed size={8}/> Autonomous</span></div><h1>Agentic Intelligence</h1><p>Maia's operating brain, tools, memory, autonomous goals, property reasoning and WhatsApp route in one control surface.</p></div>
      ...
      <section className={styles.analyticsGrid}>
        ...
        <article className={styles.analyticsCard}><header><span>Automation Usage</span><button>7 days <ChevronDown size={12}/></button></header><div className={styles.usage}><strong>{successRate}%</strong><small>Success rate</small><div className={styles.sparkline}/></div></article>
