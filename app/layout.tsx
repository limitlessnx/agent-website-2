...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    siteName: "Fluxknight",
    title: "Fluxknight — AI Agents & Business Automation for Growing Companies",
    description:
      "Deploy AI sales, customer support, WhatsApp, voice, lead generation, email, CRM, and workflow automation through one connected business operating system.",
    images: [{ url: "/og-image.png", width: 1200, height: 630, alt: "Fluxknight AI agents and business automation" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "Fluxknight — AI Agents & Business Automation",
    description:
      "AI agents for sales, support, WhatsApp, voice, lead generation, email, CRM and workflow automation.",
    images: ["/og-image.png"],
  },
  robots: {
    index: true,
