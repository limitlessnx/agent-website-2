...
const pricingPlans = [
  ...
  { slug: "plus", name: "Plus", firstMonth: "₦300,000", ongoing: "₦100,000/month", description: "Use up to two customer channels with automated follow-up and reminders so every lead stays tracked and followed up.", features: ["5,000 monthly Flux Credits", "Everything in Basic", "Use up to 2 customer channels", "Automated follow-up + reminders", "Missed-lead recovery", "Follow up again with interested or inactive leads", "Human handoff across both channels"], cta: "Choose Plus" },
