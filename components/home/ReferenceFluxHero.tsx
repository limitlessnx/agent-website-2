  ...
  return (
    <section className="relative overflow-hidden bg-[#03000A] text-neutral-50 selection:bg-purple-500/30">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <svg className="absolute bottom-[18rem] right-[-33rem] h-[28rem] w-[62rem] opacity-45 sm:bottom-[-8rem] sm:right-[-3rem] sm:h-[36rem] sm:w-[72rem] sm:opacity-80" viewBox="0 0 1200 600" fill="none" aria-hidden="true">
      ...
      <div className="relative z-10 mx-auto grid min-h-[auto] max-w-7xl grid-cols-1 items-center gap-10 px-5 pb-16 pt-14 sm:px-6 sm:pb-24 sm:pt-20 lg:min-h-[85vh] lg:grid-cols-12 lg:gap-8 lg:pb-40 lg:pt-24">
            ...
            <div className="absolute inset-0 overflow-hidden rounded-2xl bg-gradient-to-br from-white/20 via-white/5 to-transparent p-[1px]">
              ...
              <div className="relative flex h-full flex-row overflow-hidden rounded-2xl text-sm">
                <aside className="hidden w-48 flex-col border-r border-white/5 bg-white/[0.02] pt-6 md:flex">
                  <div className="mb-8 px-6"><BarChart3 className="h-6 w-6 text-purple-500" /></div>
                ...
                <div className="flex flex-1 flex-col overflow-hidden p-4 md:p-6">
                  <div className="mb-4 flex items-start justify-between md:mb-6">
                    ...
                    <div className="flex items-center gap-2 rounded-md border border-white/10 bg-white/5 px-2.5 py-1.5 text-[10px] text-neutral-300 md:px-3 md:text-xs"><CalendarDays className="h-3.5 w-3.5 md:h-4 md:w-4" /> This month</div>
                  </div>
