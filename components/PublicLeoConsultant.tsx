  ...
  return (
    <aside className={`public-leo ${open ? "open" : ""}`} aria-label="Fluxknight Leo support assistant">
      ...
      <style jsx>{`
        ...
        @keyframes leoLauncherBreathe{0%,58%,100%{transform:scale(1);box-shadow:0 18px 55px rgba(15,23,42,.38),inset 0 1px 0 rgba(255,255,255,.28)}66%{transform:scale(1.025);box-shadow:0 20px 64px rgba(76,29,149,.32),0 0 28px rgba(139,92,246,.16),inset 0 1px 0 rgba(255,255,255,.3)}74%{transform:scale(1.012)}82%{transform:scale(1.028);box-shadow:0 20px 66px rgba(76,29,149,.34),0 0 34px rgba(139,92,246,.2),inset 0 1px 0 rgba(255,255,255,.3)}}@keyframes leoLauncherPulse{0%,52%{transform:scale(.94);opacity:0}60%{opacity:.58}78%{transform:scale(1.28);opacity:0}100%{transform:scale(1.28);opacity:0}}@keyframes leoStatusPulse{0%,100%{box-shadow:0 0 0 0 rgba(139,92,246,.34),0 0 12px rgba(139,92,246,.7)}55%{box-shadow:0 0 0 7px rgba(139,92,246,0),0 0 16px rgba(139,92,246,.82)}}@keyframes leoDot{0%,100%{transform:translateY(0);opacity:.45}50%{transform:translateY(-3px);opacity:1}}
