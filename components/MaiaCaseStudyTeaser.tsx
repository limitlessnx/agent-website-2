    ...
    <section className={styles.section} id="maia-case-study" aria-labelledby="maia-case-study-title">
      ...
      >
        <div className={styles.proofVisual} aria-label="Maia real estate enquiry and lead workflow preview">
          <img className={styles.proofImage} src="/maia-hero-generated.webp" alt="" aria-hidden="true" loading="lazy" decoding="async" />
          <div className={styles.visualShade} aria-hidden="true" />

          <div className={styles.whatsappBadge} aria-label="WhatsApp enquiry">
            <WhatsAppMark />
          </div>
          ...
          <div className={styles.agentBadge}><span>✦</span><div><small>AI Sales Agent</small><strong>Maia</strong></div></div>
          <div className={styles.connectorLine} aria-hidden="true" />

          <div className={styles.leadPanel}>
            <div className={styles.leadPanelHead}><Database size={15} /><span>Limitless Realty</span></div>
            ...
            <div className={styles.inspection}><CalendarCheck2 size={15} /><div><small>Inspection scheduled</small><strong>Sat, 16 Nov · 10:00 AM</strong></div></div>
          </div>
