...
import IndustryPricingCarousel from "@/components/industry/IndustryPricingCarousel";
      ...
      <section id="plans" style={{ padding: "88px 24px 104px", borderTop: `1px solid ${colors.border}`, background: "linear-gradient(180deg,#0a0414 0%,#080311 100%)" }}>
        <div style={{ maxWidth: 1220, margin: "0 auto" }}>
          <div style={{ maxWidth: 780, marginBottom: 34 }}>
            ...
            <h2 style={{ margin: "12px 0", fontSize: "clamp(2.2rem,4.5vw,3.8rem)", letterSpacing: "-.05em" }}>Start simple. Add operational depth only when the business needs it.</h2>
            <p style={{ margin: 0, color: colors.muted, lineHeight: 1.8 }}>The same five Fluxknight pricing options shown on the homepage apply here. The pricing structure stays consistent while the workflow and operational scope adapt to {industry.name}.</p>
          </div>
          <IndustryPricingCarousel industry={industry} />
        </div>
      </section>
