      ...
      <div className={styles.leakDetailGrid}>
        <div className={styles.campaignCard}>
          ...
          <div className={styles.campaignContextFrame}>
            <img
              src="https://d2ol7oe51mr4n9.cloudfront.net/user_3GTV38w6zCm0fb6vRYkPEmmsNnH/dda57b32-bb9c-4322-8ccb-f367731b3702.jpg?v=20260919-3"
              alt="Property launch campaign showing social engagement, comments and buyer interest around a real estate launch."
