...
const industryMeta = [
  ...
  { id: "real-estate", icon: Building2, image: "/industry-product-real-estate.svg", eyebrow: "Property enquiries", text: "Turn property interest into qualified conversations, inspection bookings and persistent follow-up across the buyer journey." },
...
export default function IndustryCarousel() {
  const industries = useMemo(() => {
    ...
    return industryMeta.map((industry) => ({
      ...industry,
      title: names.get(industry.id) ?? industry.id,
    }));
  }, []);
