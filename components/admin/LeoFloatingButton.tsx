...
export default function LeoFloatingButton() {
  ...
  const statusLabel = operationState === "investigating" ? "Investigating" : operationState === "executing" ? "Executing" : operationState === "approval_required" ? "Approval required" : operationState === "verified" ? "Verified" : operationState === "error" ? "Needs attention" : "Ready";
