...
export const LEO_TOOLS: LeoToolDefinition[] = [
  ...
  },
  {
    ...
    description: "Create or update a Public Leo visitor record after the visitor supplies name and email.",
    scopes: ["public", "super_admin"],
    readOnly: false,
    approval: "none",
  },
  {
    key: "leo.public.evaluation.update",
    title: "Update public business evaluation",
    description: "Save the latest business need, pain points, opportunities, channels, plan fit and concise conversation summary for the current Public Leo visitor.",
    scopes: ["public", "super_admin"],
    readOnly: false,
    approval: "none",
  },
  {
    key: "leo.public.handoff.request",
    title: "Request human follow-up",
    description: "Record that the Public Leo visitor wants a Fluxknight team member to follow up, including preferred contact method and optional phone or WhatsApp number.",
    scopes: ["public", "super_admin"],
    readOnly: false,
    approval: "none",
  },
